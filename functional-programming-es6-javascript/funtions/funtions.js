...
// Utilizar el método map para duplicar cada elemento del arreglo
// [2, 4, 6, 8, 10, 12]

/*const newArr = arr.map(function(elemento) {
    return elemento * 2;
});
console.log(newArr);*/
...
/*const newArr = arr.filter(function (elemento) {
    return elemento % 2 === 0;
});
console.log(newArr);*/
...
// 21
/*const newArr = arr.reduce(function (acumulador, elemento) {
...
/*const ferraris = cars.filter(function (item) {
...
/*const nineties = cars.filter(function (item) {
...
/*const list = cars.map(function (item) {
...
/*const bmwSum = cars.reduce(function (acum, val){
    return acum + val.price;
}, 0);
console.log(bmwSum);*/